#"Professional Rock Paper Scissors Players" often say things to one anoother to subconosciously influence one anothers' choices, so I added something of the sort here. 
def saysomething():
